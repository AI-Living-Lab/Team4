...
사용법:
  python tools/debug/compare.py --in_dir _debug_out/sweep
  python tools/debug/compare.py --in_dir _debug_out/sweep --by config
  python tools/debug/compare.py --in_dir _debug_out/sweep --format md --out compare.md
  python tools/debug/compare.py --in_dir _debug_out/sweep --format csv --out compare.csv
  python tools/debug/compare.py --in_dir _debug_out/sweep --samples short,longest
