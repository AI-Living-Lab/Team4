...
사용:
  python tools/gen_cot_data.py --src data/train/unav100_v2_cot.json --mode p2 --out data/train/unav100_v2_p2.json
  python tools/gen_cot_data.py --src ... --mode p4 --out ...      [--limit 5 = 미니검증]
"""
