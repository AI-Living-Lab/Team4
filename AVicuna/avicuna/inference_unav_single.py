...
def parse_args():
    ...
    parser.add_argument("--audio_path", type=str, default="demo/jump.npy")
    parser.add_argument("--query", type=str, default="Is the person dancing from 43 to 83? And What is he doing after that and when?")
...
if __name__ == "__main__":
    ...
    audio = torch.tensor(np.load(args.audio_path), dtype=torch.bfloat16)
    with torch.no_grad():
