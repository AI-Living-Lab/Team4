#!/bin/bash
# ============================================================
# UnAV-100 1ep high-res (base: low-res PU-VALOR 0.2ep)
#   - A_qkv와 같은 세팅 (video_max_frames=128, eff_batch=4)
#   - PU-VALOR base만 0.5ep → 0.2ep로 변경
#   - 10 checkpoints (0.1~1.0ep)
#   - GPU 4,5 (2 GPUs)
# ============================================================
set -eo pipefail
