#!/bin/bash
# ARC-Hunyuan inference PID 종료 → 자동 eval
set -e
PID="${1:-0}"
OUT_DIR=/workspace/jsy/outputs/base/ArcHunyuan/Unav100QA
RESULTS="$OUT_DIR/test_results_rank0.json"
TEST_JSON=/workspace/jsy/outputs/base/ArcHunyuan/test.json
EVAL_SCRIPT=/workspace/jsy/scripts/eval_miou_multiseg_arc_hunyuan.py
