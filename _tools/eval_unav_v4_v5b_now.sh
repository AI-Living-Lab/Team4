...
#   - GPU 0,1,2,3 (4-shard parallel each model, sequential)
#
# Starts IMMEDIATELY (does not wait for v6_a). v6_a UnAV is handled separately
# by eval_unav_v6a_after.sh on GPU 4,5,6,7 after training completes.
# ============================================================
set -o pipefail
source /home/aix23102/anaconda3/etc/profile.d/conda.sh
conda activate salmonn2plus

LOG=/home/aix23102/audiolm/vS2_eunji/_tools/eval_unav_v4_v5b_now.log
...
echo | tee -a "$LOG"
echo "============== UnAV (v4 + v5_b) SUMMARY ==============" | tee -a "$LOG"
for d in \
