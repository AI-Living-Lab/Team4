#!/bin/bash
# ============================================================
# [B] High-res + LoRA(q/k/v/o + MLP) + lm_head + embed
#   - Base: PU-VALOR 0.5ep checkpoint (lora_timetoken)
#   - UnAV-100 0.2ep, GPU 6,7
# ============================================================
set -eo pipefail
...
OUTPUT_DIR=/data0/aix23102/checkpoints_open_aligner/ablation_B_qkvo_mlp_highres
RUN_NAME=ablation_B_qkvo_mlp
