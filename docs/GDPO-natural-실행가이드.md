...
| 종류 | 파일 |
|---|---|
| 트레이너 | `gdpo/gdpo_trainer_batch_natural.py` |
| 리워드 | `gdpo/reward_functions_rM_sep3_natural.py` |
| config | `gdpo/config_sep3_natural.yaml` |
| 런처 | `gdpo/run_rMsep3_natural.sh` |
...
bash gdpo/run_rMsep3_natural.sh
...
TTI_DEBUG=1 TTI_DEBUG_STEPS=3 bash gdpo/run_rMsep3_natural.sh
