"""Eval for Experiment G: JSON + label set constraint"""
...
with open('data/annotations/unav100_annotations.json') as f:
    gt_data = json.load(f)
with open('output/json_labelset_full.json') as f:
...
print('=== Experiment G: JSON + Label Set Constraint ===')
...
print(f'  Exp F (JSON prompt + CLAP):    15.50')
print(f'  Exp G (JSON + label set):      {avg_all:.2f}')
