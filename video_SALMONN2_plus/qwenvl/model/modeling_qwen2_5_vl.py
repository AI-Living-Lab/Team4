...
from qwenvl.data.rope2d import get_rope_index_25 as _rope2d_get_rope_index_25
import numpy as np
import math
...
class video_SALMONN2_plus(Qwen2_5_VLPreTrainedModel, GenerationMixin):
    ...
    def get_rope_index(
        ...
        일치함을 확인한 상태에서 사용한다.
        """
        if time_token_id_range is None:
            cfg_range = getattr(self.config, "time_token_id_range", None)
